...
<head>
    ...
    <title>TechStore - MacBook Pro M2</title>
            ...
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center gap-4 ml-auto">
                    <a href="/panier" class="p-2 text-gray-600 hover:text-indigo-600 transition-colors relative">
                        ...
                        <span
                            class="absolute top-0 right-0 inline-flex items-center justify-center px-1.5 py-0.5 text-xs font-bold leading-none text-white transform translate-x-1/4 -translate-y-1/4 bg-red-600 rounded-full">2</span>
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-16">
            ...
            <div>
                ...
                <div class="border-t border-b border-gray-100 py-6 mb-8 space-y-4">
                    ...
                    <!-- Variations -->
                    <div>
                        <span class="block text-sm font-medium text-gray-700 mb-2">Couleur</span>
                        <div class="flex gap-3">
                            <button
                                class="w-8 h-8 rounded-full bg-gray-800 ring-2 ring-offset-2 ring-gray-800"></button>
                            <button
                                class="w-8 h-8 rounded-full bg-gray-200 ring-2 ring-offset-2 ring-transparent hover:ring-gray-300"></button>
                        </div>
                    </div>
                </div>
