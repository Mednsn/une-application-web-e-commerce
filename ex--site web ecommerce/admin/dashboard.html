    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside class="w-64 bg-gray-900 text-white flex-shrink-0 hidden lg:flex flex-col">
            ...
            <nav class="flex-1 px-2 py-4 space-y-2 overflow-y-auto">
                <a href="dashboard.html" class="flex items-center px-4 py-2 bg-gray-800 text-white rounded-md group">
            ...
            <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-100 p-6">
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-100 mb-8">
                    <div class="px-6 py-4 border-b border-gray-100 flex justify-between items-center">
                        ...
                        <a href="orders.html" class="text-indigo-600 hover:text-indigo-900 text-sm font-medium">Tout
                            voir</a>
                    </div>
